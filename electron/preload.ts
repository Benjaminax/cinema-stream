...
const api = {
  ...
  openStreamWindow: (url: string, title: string) => ipcRenderer.invoke('open-stream-window', { url, title }),
  openYFlixWindow: (url: string, title: string) => ipcRenderer.invoke('open-stream-window', { url, title }),
